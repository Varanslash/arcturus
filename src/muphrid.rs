    ...
    while ip < code.len() {
        ...
        match code[ip] {
            ...
            0x02 => { // SUB
                ...
                // Reverse (stack pops in reverse order)
                values.reverse();
                
                // First value is the starting point
                let mut diff = values[0];
